...
export async function populateDefaultChartOfAccounts(supabase: SupabaseClient<Database>, companyId: string, countryCode: string) {
  ...
  try {
    ...
    addAccountToBatch('11101', { account_code: '11101', account_name: 'Cash in Hand', account_type: 'asset', account_group: 'Cash & Cash Equivalents', parent_account_id: insertedAccountIds['11100'], is_group: false, balance_type: 'debit', comment: 'Physical cash held by the company' });
    addAccountToBatch('11102', { account_code: '11102', account_name: 'Bank Account - Primary', account_type: 'asset', account_group: 'Cash & Cash Equivalents', parent_account_id: insertedAccountIds['11100'], is_group: false, balance_type: 'debit', comment: 'Main operational bank account' });
    addAccountToBatch('11103', { account_code: '11103', account_name: 'Bank Account - Savings', account_type: 'asset', account_group: 'Cash & Cash Equivalents', parent_account_id: insertedAccountIds['11100'], is_group: false, balance_type: 'debit', comment: 'Savings bank account' });
    ...
    addAccountToBatch('11201', { account_code: '11201', account_name: 'Trade Debtors', account_type: 'asset', account_group: 'Accounts Receivable', parent_account_id: insertedAccountIds['11200'], is_group: false, balance_type: 'debit', comment: 'Amounts due from customers for goods sold or services rendered' });
    ...
    addAccountToBatch('11301', { account_code: '11301', account_name: 'Raw Materials Inventory', account_type: 'asset', account_group: 'Inventory', parent_account_id: insertedAccountIds['11300'], is_group: false, balance_type: 'debit', comment: 'Cost of raw materials available for use in production' });
    addAccountToBatch('11302', { account_code: '11302', account_name: 'Work in Progress Inventory', account_type: 'asset', account_group: 'Inventory', parent_account_id: insertedAccountIds['11300'], is_group: false, balance_type: 'debit', comment: 'Cost of goods partially completed in the manufacturing process' });
    addAccountToBatch('11303', { account_code: '11303', account_name: 'Finished Goods Inventory', account_type: 'asset', account_group: 'Inventory', parent_account_id: insertedAccountIds['11300'], is_group: false, balance_type: 'debit', comment: 'Cost of completed goods available for sale' });
    ...
    addAccountToBatch('11401', { account_code: '11401', account_name: 'Prepaid Rent', account_type: 'asset', account_group: 'Prepaid Expenses', parent_account_id: insertedAccountIds['11400'], is_group: false, balance_type: 'debit', comment: 'Rent paid in advance for future periods' });
    addAccountToBatch('11402', { account_code: '11402', account_name: 'Prepaid Insurance', account_type: 'asset', account_group: 'Prepaid Expenses', parent_account_id: insertedAccountIds['11400'], is_group: false, balance_type: 'debit', comment: 'Insurance premiums paid in advance' });
    ...
    addAccountToBatch('12101', { account_code: '12101', account_name: 'Land', account_type: 'asset', account_group: 'Land & Buildings', parent_account_id: insertedAccountIds['12100'], is_group: false, balance_type: 'debit', comment: 'Cost of land owned by the company' });
    addAccountToBatch('12102', { account_code: '12102', account_name: 'Buildings', account_type: 'asset', account_group: 'Land & Buildings', parent_account_id: insertedAccountIds['12100'], is_group: false, balance_type: 'debit', comment: 'Cost of buildings owned and used by the company' });
    ...
    addAccountToBatch('12201', { account_code: '12201', account_name: 'Production Machinery', account_type: 'asset', account_group: 'Plant & Machinery', parent_account_id: insertedAccountIds['12200'], is_group: false, balance_type: 'debit', comment: 'Machinery used directly in the production process' });
    addAccountToBatch('12202', { account_code: '12202', account_name: 'Office Equipment', account_type: 'asset', account_group: 'Plant & Machinery', parent_account_id: insertedAccountIds['12200'], is_group: false, balance_type: 'debit', comment: 'Equipment used in administrative and office functions' });
    ...
    addAccountToBatch('21101', { account_code: '21101', account_name: 'Trade Creditors', account_type: 'liability', account_group: 'Accounts Payable', parent_account_id: insertedAccountIds['21100'], is_group: false, balance_type: 'credit', comment: 'Amounts owed to suppliers for goods purchased or services received' });
    ...
    addAccountToBatch('21301', { account_code: '21301', account_name: 'Accrued Salaries', account_type: 'liability', account_group: 'Accrued Expenses', parent_account_id: insertedAccountIds['21300'], is_group: false, balance_type: 'credit', comment: 'Salaries earned by employees but not yet paid' });
    addAccountToBatch('21302', { account_code: '21302', account_name: 'Accrued Utilities', account_type: 'liability', account_group: 'Accrued Expenses', parent_account_id: insertedAccountIds['21300'], is_group: false, balance_type: 'credit', comment: 'Utility expenses incurred but not yet billed or paid' });
    ...
    // ----------------------- PROVISIONS --------------------------------
    addAccountToBatch('23100', { account_code: '23100', account_name: 'Provision for Employee Benefits', account_type: 'liability', account_group: 'Provision for Employee Benefits', parent_account_id: insertedAccountIds['23000'], is_group: true, balance_type: 'credit', comment: 'Estimated liabilities for future obligations' });
    ...
    addAccountToBatch('41101', { account_code: '41101', account_name: 'Domestic Sales', account_type: 'income', account_group: 'Product Sales', parent_account_id: insertedAccountIds['41100'], is_group: false, balance_type: 'credit', comment: 'Sales within the country' });
    addAccountToBatch('41102', { account_code: '41102', account_name: 'Export Sales', account_type: 'income', account_group: 'Product Sales', parent_account_id: insertedAccountIds['41100'], is_group: false, balance_type: 'credit', comment: 'Sales to customers outside the country' });
    ...
    addAccountToBatch('52101', { account_code: '52101', account_name: 'Employee Benefits Expense', account_type: 'expense', account_group: 'Salaries & Wages', parent_account_id: insertedAccountIds['52100'], is_group: false, balance_type: 'debit', comment: 'Costs associated with employee benefits (e.g., health insurance, retirement plans)' });
    ...
    addAccountToBatch('52301', { account_code: '52301', account_name: 'Electricity Expense', account_type: 'expense', account_group: 'Utilities', parent_account_id: insertedAccountIds['52300'], is_group: false, balance_type: 'debit', comment: 'Cost of electricity consumption' });
    addAccountToBatch('52302', { account_code: '52302', account_name: 'Water Expense', account_type: 'expense', account_group: 'Utilities', parent_account_id: insertedAccountIds['52300'], is_group: false, balance_type: 'debit', comment: 'Cost of water consumption' });
    ...
    addAccountToBatch('52701', { account_code: '52701', account_name: 'Online Advertising', account_type: 'expense', account_group: 'Advertising & Marketing', parent_account_id: insertedAccountIds['52700'], is_group: false, balance_type: 'debit', comment: 'Expenses for digital advertising campaigns' });
    addAccountToBatch('52702', { account_code: '52702', account_name: 'Print Media', account_type: 'expense', account_group: 'Advertising & Marketing', parent_account_id: insertedAccountIds['52700'], is_group: false, balance_type: 'debit', comment: 'Expenses for advertising in newspapers, magazines, etc.' });
    ...
    addAccountToBatch('52901', { account_code: '52901', account_name: 'Legal Fees', account_type: 'expense', account_group: 'Professional Fees', parent_account_id: insertedAccountIds['52900'], is_group: false, balance_type: 'debit', comment: 'Expenses for legal services' });
    addAccountToBatch('52902', { account_code: '52902', account_name: 'Audit Fees', account_type: 'expense', account_group: 'Professional Fees', parent_account_id: insertedAccountIds['52900'], is_group: false, balance_type: 'debit', comment: 'Expenses for financial audit services' });
