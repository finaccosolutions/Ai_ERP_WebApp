...
import { Settings, Users, Database, Shield, Plus } from 'lucide-react';
...
function Admin() {
  ...
  const adminModules = [
    { name: 'User Management', icon: Users, count: 45, color: 'bg-blue-500' },
    { name: 'System Settings', icon: Settings, count: 1, color: 'bg-green-500' },
    { name: 'Data Backup', icon: Database, count: 7, color: 'bg-purple-500' },
    { name: 'Security', icon: Shield, count: 3, color: 'bg-red-500' },
  ];
