// src/pages/Inventory/masters/ItemGroupListPage.tsx
import React, { useState, useEffect } from 'react';
import { Plus, Search, Tag, Edit, Trash2, RefreshCw, Save, ArrowLeft, Filter, Info } from 'lucide-react'; // Added Info icon
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <Link to="/inventory/masters/item-groups/new">
                ...
                {itemGroups.map((group) => (
                  <tr key={group.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <Link to={`/inventory/masters/item-groups/edit/${group.id}`}>
